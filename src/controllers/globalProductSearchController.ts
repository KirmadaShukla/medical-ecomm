...
export const searchGlobalProductsForVendor = catchAsyncError(async (req: Request, res: Response, next: NextFunction): Promise<void> => {
...
export const getVendorProductsByGlobalProduct = catchAsyncError(async (req: Request, res: Response, next: NextFunction): Promise<void> => {
...
export const checkGlobalProductAvailability = catchAsyncError(async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  const { globalProductId } = req.params;
